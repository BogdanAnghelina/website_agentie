  ...
  return (
    <>
      ...
      <div className="relative overflow-hidden" style={{ background: 'linear-gradient(140deg, #171720 0%, #0E2050 100%)' }}>
        ...
        <section className="relative z-10 flex items-center mx-auto gap-[60px]" style={{ minHeight: '100dvh', padding: '112px 56px 80px', maxWidth: 1300 }} aria-label="Facebook Ads hero">
