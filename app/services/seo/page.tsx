...
const faqItems = [
  { question: 'Cât durează SEO să dea rezultate?', answer: 'Primele mișcări de poziție se văd după 6-10 săptămâni. Rezultate semnificative de trafic — între 3 și 6 luni, în funcție de competitivitatea nișei și starea actuală a site-ului. SEO nu e o soluție rapidă — e o investiție pe termen lung cu returns compuse.' },
  { question: 'De câți bani am nevoie pentru SEO?', answer: 'SEO nu are "buget publicitar" ca Google Ads. Plătești serviciul de management/optimizare. Prețul variază în funcție de complexitate: un site local mic vs. un magazin online cu mii de produse sunt cu totul diferite. Îți spunem un număr concret după audit.' },
  { question: 'Pot face SEO și Google Ads simultan?', answer: 'Nu doar că poți — e recomandat. Google Ads îți aduc trafic instant în timp ce SEO se construiește. Datele din Google Ads (ce cuvinte cheie convertesc) informează strategia SEO. Le construim să funcționeze împreună.' },
  { question: 'Ce se întâmplă cu pozițiile dacă oprim SEO?', answer: 'Pozițiile se deteriorează treptat în 3-6 luni dacă competitorii continuă să lucreze la SEO. Spre deosebire de Google Ads care se opresc instant, SEO are un "momentum" care te protejează pe termen scurt. Dar pe termen lung, trebuie menținut.' },
  { question: 'Aveți garanție de rezultate?', answer: 'Nu. Nicio agenție serioasă nu garantează poziții Google — pentru că Google, nu noi, decide. Ce garantăm: implementare corectă, transparență completă și o strategie bazată pe date. Orice agenție care "garantează #1 în Google" minte.' },
  { question: 'Funcționează SEO în orice industrie?', answer: 'Da, cu mențiunea că competitivitatea diferă enorm. Un avocat specializat sau o clinică dentară dintr-un oraș mic poate ranka relativ rapid. E-commerce sau servicii financiare naționale cer mult mai mult timp și resurse. Îți spunem sincer dacă SEO e potrivit și rentabil pentru tine.' },
]
